...
public class TransformationStage : StageBase
{
    ...
    public TransformationStage(TextMeshProUGUI stateText, List<string> stageDescs, string subDesc, int id) : base(
        stateText, stageDescs, subDesc, id)
    {
    }
    ...
    public override void OnStageBegin()
    {
        ...
        Vector3 enemyPos = player.CurrentRoom.roomTransform.GetChild(player.CurrentRoom.roomTransform.childCount - 1)
            .position;
